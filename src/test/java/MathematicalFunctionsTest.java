...
public class MathematicalFunctionsTest {
    ...
    public void factorialPositiveTest() {
        Assertions.assertEquals(120, MathematicalFunctions.factorial(5));
    }
    @Test
    ...
    public void areaTrianglePositiveTest() {
        Assertions.assertEquals((float) 6, MathematicalFunctions.areaTriangle(3,4,5));
    }
    ...
    public void additionTest(){
        Assertions.assertEquals(5, MathematicalFunctions.addition(-2, 7));
    }
    @Test
    public void subtractionTest(){
        Assertions.assertEquals(-5, MathematicalFunctions.subtraction(2, 7));
    }
    @Test
    public void multiplicationTest(){
        Assertions.assertEquals(20, MathematicalFunctions.multiplication(4, 5));
    }
    @Test
    public void divisionTest(){
       Assertions.assertEquals((float) 0.8, MathematicalFunctions.division(4, 5));
    }
    @Test
